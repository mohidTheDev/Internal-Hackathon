...
func _export_level(path: String) -> void:
	...
	root.gridHoles = holes.duplicate()
	...
	var gates_type: Array = []
	var gates_orientation: Array = []
	var gates_coords: Array = []
	for g in gates:
	...
	var t_coords: Array = []; var t_up: Array = []; var t_down: Array = []
	var t_left: Array = []; var t_right: Array = []
	var t_active: Array = []; var t_inactive: Array = []
	for t in towers:
	...
	var s_coords: Array = []; var s_gate_idx: Array = []; var s_default: Array = []
	for s in slots:
